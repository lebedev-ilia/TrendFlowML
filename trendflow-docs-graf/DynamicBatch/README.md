...
**Главный индекс vault**: [../docs/MAIN_INDEX.md](../docs/MAIN_INDEX.md)

**Документы**:
- [docs/IMPLEMENTATION_PLAN.md](docs/IMPLEMENTATION_PLAN.md)
- [docs/DynamicBatching_Q_A.md](docs/DynamicBatching_Q_A.md)
- [docs/BENCHMARK_REGISTRY_CONTRACT.md](docs/BENCHMARK_REGISTRY_CONTRACT.md)
- [docs/DYNAMIC_BATCHING_CHECKLIST.md](docs/DYNAMIC_BATCHING_CHECKLIST.md)
