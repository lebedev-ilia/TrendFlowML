...
**README**: [DynamicBatch/README.md](../DynamicBatch/README.md)

**Главный индекс документации**:
- [IMPLEMENTATION_PLAN.md](../DynamicBatch/docs/IMPLEMENTATION_PLAN.md) — план реализации
- [DynamicBatching_Q_A.md](../DynamicBatch/docs/DynamicBatching_Q_A.md) — вопросы и ответы
- [BENCHMARK_REGISTRY_CONTRACT.md](../DynamicBatch/docs/BENCHMARK_REGISTRY_CONTRACT.md) — контракт реестра бенчмарков
- [DYNAMIC_BATCHING_CHECKLIST.md](../DynamicBatch/docs/DYNAMIC_BATCHING_CHECKLIST.md) — чеклист реализации
- [BENCHMARK_ADEQUACY_ANALYSIS.md](../DynamicBatch/docs/BENCHMARK_ADEQUACY_ANALYSIS.md) — анализ адекватности бенчмарков
- [POSTGRESQL_LOCAL_SETUP.md](../DynamicBatch/docs/POSTGRESQL_LOCAL_SETUP.md) — локальная настройка PostgreSQL
...
**Главный индекс**: [Models/docs/MAIN_INDEX.md](../Models/docs/MAIN_INDEX.md)

**Ключевые разделы**:
- [contracts/](../Models/docs/contracts/) — контракты моделей (baseline, v1, v2)
- [plan_dev/](../Models/docs/plan_dev/) — планы разработки
- [roadmaps/](../Models/docs/roadmaps/) — roadmap развития
- [QA/](../Models/docs/QA/) — вопросы и ответы по контрактам
...
**README**: [Fetcher/README.md](../Fetcher/README.md)

**Главный индекс**: [Fetcher/docs/INDEX.md](../Fetcher/docs/INDEX.md)

**Ключевые разделы**:
- [IMPLEMENTATION/](../Fetcher/docs/IMPLEMENTATION/README.md) — этапы реализации
- [E2E_FETCHER_DATAPROCESSOR.md](../Fetcher/docs/E2E_FETCHER_DATAPROCESSOR.md) — интеграция с DataProcessor
...
| Раздел | Описание | Индекс |
|--------|----------|--------|
| `k8s/` | Kubernetes манифесты | [k8s/README.md](../k8s/README.md) |
| `configs/` | Профили и бенчмарки | [configs/README.md](../configs/README.md) |
| `storage/` | Result store, QA runbooks | [storage/result_store/RUNBOOK_WEEKLY_QA_FROM_SCRATCH.md](../storage/result_store/RUNBOOK_WEEKLY_QA_FROM_SCRATCH.md) |
| `example/` | Smoke-сценарии Audit v3 | [example/text_audit_v3_smoke/scenarios/README.md](../example/text_audit_v3_smoke/scenarios/README.md) |

**DataProcessor sub-indexes** (внутренние хабы):
- [dp_models/MAIN_INDEX.md](../DataProcessor/dp_models/MAIN_INDEX.md)
- [embedding_service/MAIN_INDEX.md](../DataProcessor/embedding_service/MAIN_INDEX.md)
- [scripts/MAIN_INDEX.md](../DataProcessor/scripts/MAIN_INDEX.md)
- [storage/MAIN_INDEX.md](../DataProcessor/storage/MAIN_INDEX.md)
...
- **[Models/docs/MAIN_INDEX.md](../Models/docs/MAIN_INDEX.md)** — ML-модели и контракты
- **[Fetcher/docs/INDEX.md](../Fetcher/docs/INDEX.md)** — Fetcher и ingestion
- **[DynamicBatch/README.md](../DynamicBatch/README.md)** — глобальный scheduler
