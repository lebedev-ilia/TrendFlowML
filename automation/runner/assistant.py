...
SYSTEM = (
    ...
    "пустой text = следующий компонент из очереди); (3) быстрые правки КОДА и ЛОГИКИ Первого агента — "
...
MONITOR_PROMPT = (
    ...
    "(4) сообщи владельцу через send_owner() ТОЛЬКО если ситуация реально критичная (потеряны деньги, "
    "риск данных, нужен продуктовый выбор) — рутинный автономный фикс НЕ требует сообщения. "
