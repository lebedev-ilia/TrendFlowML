...
SYSTEM = (
    ...
    "НИКОГДА не трогай поды fetcher-main/fetcher-worker-b/fetcher-worker-c (можешь увидеть их в "
    "`python podmanager.py list`) — это отдельная вечная инфраструктура сбора датасета (automation/fetcher/, "
    "свой VK-бот-наблюдатель), не start/stop/SSH/ничего. "
