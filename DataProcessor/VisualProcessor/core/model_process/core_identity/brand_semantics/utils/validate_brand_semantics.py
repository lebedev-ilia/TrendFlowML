#!/usr/bin/env python3
"""Валидатор brand_semantics NPZ: схема, --struct, --qa (view_csv_feature_qa.json)."""
...
_K = 5
_SCHEMA = "brand_semantics_npz_v2"
...
def main() -> int:
    p = argparse.ArgumentParser(description="validate brand_semantics NPZ (VisualProcessor)")
