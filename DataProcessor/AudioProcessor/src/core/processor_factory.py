...
def create_main_processor(args: Any, extractor_keys: List[str], extractor_config: Any = None) -> MainProcessor:
    ...
    return MainProcessor(
        ...
        pitch_sample_rate=int(getattr(args, "pitch_sample_rate", 22050)),
        pitch_fmin=float(getattr(args, "pitch_fmin", 50.0)),
        pitch_fmax=float(getattr(args, "pitch_fmax", 2000.0)),
        pitch_hop_length=int(getattr(args, "pitch_hop_length", 512)),
        pitch_frame_length=int(getattr(args, "pitch_frame_length", 2048)),
        pitch_backend=str(getattr(args, "pitch_backend", "classic")),
        pitch_channel_mode=str(getattr(args, "pitch_channel_mode", "first")),
        pitch_torchcrepe_batch_size=int(getattr(args, "pitch_torchcrepe_batch_size", 1)),
        pitch_enable_basic_stats=bool(getattr(args, "pitch_enable_basic_stats", True)),
        pitch_enable_stability_metrics=bool(getattr(args, "pitch_enable_stability_metrics", False)),
        pitch_enable_delta_features=bool(getattr(args, "pitch_enable_delta_features", False)),
        pitch_enable_method_stats=bool(getattr(args, "pitch_enable_method_stats", False)),
        pitch_enable_time_series=bool(getattr(args, "pitch_enable_time_series", False)),
        ...
        # Audit v3: default fixed bands. Support both flags for backwards compatibility.
        band_energy_use_mel_bands=bool(getattr(args, "band_energy_use_mel_bands", False)) and not bool(getattr(args, "band_energy_no_mel_bands", False)),
        band_energy_n_mels=int(args.band_energy_n_mels),
        band_energy_method=str(args.band_energy_method),
        band_energy_average_channels=(
            False
            if bool(getattr(args, "band_energy_no_average_channels", False))
            else bool(getattr(args, "band_energy_average_channels", True))
        ),
        # Audit v3: normalization enabled by default; allow explicit opt-out.
        band_energy_enable_audio_normalization=not bool(getattr(args, "band_energy_disable_audio_normalization", False)),
        ...
        hpss_sample_rate=int(getattr(args, "hpss_sample_rate", 22050)),
        hpss_n_fft=int(getattr(args, "hpss_n_fft", 2048)),
        hpss_hop_length=int(getattr(args, "hpss_hop_length", 512)),
        hpss_average_channels=bool(getattr(args, "hpss_average_channels", True)),
        hpss_kernel_size=int(getattr(args, "hpss_kernel_size", 31)),
        hpss_margin=float(getattr(args, "hpss_margin", 1.0)),
        hpss_power=float(getattr(args, "hpss_power", 2.0)),
        hpss_enable_audio_normalization=bool(getattr(args, "hpss_enable_audio_normalization", False)),
        ...
        hpss_enable_waveforms=bool(getattr(args, "hpss_enable_waveforms", False)),
        hpss_enable_spectral_features=bool(getattr(args, "hpss_enable_spectral_features", False)),
        hpss_enable_time_series=bool(getattr(args, "hpss_enable_time_series", False)),
