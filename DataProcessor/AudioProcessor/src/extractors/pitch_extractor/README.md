...
- `pitch_jump_count`: количество больших скачков pitch (>2 semitones) (int)
- `pitch_centroid`: центроид распределения pitch (Hz) (float)
...
- `--pitch-enable-basic-stats`: включить базовые статистики (f0_mean, f0_std, f0_min, f0_max, f0_median) + дополнительные ML/аналитики метрики
...
12. **Дополнительные метрики**: pitch_contour_smoothness, pitch_jump_count, pitch_octave_distribution, pitch_centroid, pitch_skewness, pitch_kurtosis для ML/аналитики
