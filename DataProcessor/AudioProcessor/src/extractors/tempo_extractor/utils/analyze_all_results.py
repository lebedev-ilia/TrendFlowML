#!/usr/bin/env python3
"""Анализ результатов tempo_extractor."""
from __future__ import annotations
import argparse, json, sys
from pathlib import Path
from typing import Dict, Any

def analyze(rs_base: str = "dp_results/youtube", run_id_prefix: str = "test_tempo_", component_name: str = "tempo_extractor", npz_name: str = "tempo_extractor_features.npz") -> Dict[str, Any]:
...
def main():
    ...
    p.add_argument("--run-id-prefix", default="test_tempo_")
    p.add_argument("--component-name", default="tempo_extractor")
