...
PYTHONPATH="${BASE_DIR}/DataProcessor/AudioProcessor/src:${PYTHONPATH}" "${PYTHON}" "${ANALYZER}" --rs-base "${RESULTS_DIR}/youtube" --run-id-prefix "test_mfcc_" --component-name "mfcc_extractor"
