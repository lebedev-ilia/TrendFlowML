"""
Best-effort RSS/VRAM snapshots for band_energy_extractor (Audit v4.2).

Enable heavy snapshots via env:
  AP_BAND_ENERGY_RESOURCE_PROFILE=1
"""
...
def resource_profile_enabled() -> bool:
    v = os.environ.get("AP_BAND_ENERGY_RESOURCE_PROFILE", "").strip().lower()
