"""
Best-effort RSS/VRAM snapshots for loudness_extractor (Audit v4.2).

Enable via env:
  AP_LOUDNESS_RESOURCE_PROFILE=1
"""
...
def resource_profile_enabled() -> bool:
    v = os.environ.get("AP_LOUDNESS_RESOURCE_PROFILE", "").strip().lower()
