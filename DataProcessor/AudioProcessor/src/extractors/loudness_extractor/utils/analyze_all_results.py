#!/usr/bin/env python3
"""Анализ результатов loudness_extractor."""
from __future__ import annotations
import argparse, json, sys
from pathlib import Path
from typing import Dict, Any

def analyze(rs_base: str = "dp_results/youtube", run_id_prefix: str = "test_loudness_", component_name: str = "loudness_extractor", npz_name: str = "loudness_extractor_features.npz") -> Dict[str, Any]:
...
def main():
    ...
    p.add_argument("--run-id-prefix", default="test_loudness_")
    p.add_argument("--component-name", default="loudness_extractor")
