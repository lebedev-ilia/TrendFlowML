...
PYTHONPATH="${BASE_DIR}/DataProcessor/AudioProcessor/src:${PYTHONPATH}" "${PYTHON}" "${ANALYZER}" --rs-base "${RESULTS_DIR}/youtube" --run-id-prefix "test_clap_" --component-name "clap_extractor"
