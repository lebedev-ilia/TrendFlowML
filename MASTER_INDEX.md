...
- `MAIN_INDEX.md` — обзор архитектуры модели.
...
- **`MULTI_AGENT_TRAINING_STRATEGY.md`** (новое, 2026-07-18) — стратегия запуска первого baseline на
  реальных данных: чего не хватает (`DatasetBuilder` не написан), порядок действий, распределение на
  агентов (2, не 3 — см. обоснование), методология обработки фичей/обучения.
